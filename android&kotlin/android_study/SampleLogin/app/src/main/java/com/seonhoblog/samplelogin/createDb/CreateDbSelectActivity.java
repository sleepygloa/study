...
public class CreateDbSelectActivity extends AppCompatActivity {
    ...
    private CreateDbSelectActivity.DatabaseHelper dbHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        status = (TextView) findViewById(R.id.tv_createdb_select_status);
        final EditText input01 = (EditText) findViewById(R.id.et_createdb_select_dbname);

        Button queryBtn = (Button) findViewById(R.id.btn_createdb_select_inq);
    ...
    private boolean openDatabase() {
        ...
        dbHelper = new CreateDbSelectActivity.DatabaseHelper(this);
