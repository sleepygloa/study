package com.seonhoblog.samplelogin.cameraImgModify;
...
public class ImgCoverFlowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImgCoverFlowActivity.ImageAdapter coverImageAdapter = new ImgCoverFlowActivity.ImageAdapter(this);
