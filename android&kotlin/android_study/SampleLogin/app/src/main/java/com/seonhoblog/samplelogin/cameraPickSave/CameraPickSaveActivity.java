package com.seonhoblog.samplelogin.cameraPickSave;
...
public class CameraPickSaveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camerapicksave);

        final CameraSurfaceView cameraView = new CameraSurfaceView(getApplicationContext());
        FrameLayout previewFrame = (FrameLayout) findViewById(R.id.fl_camerapicksave_view);
        previewFrame.addView(cameraView);

        // 버튼 이벤트 처리
        Button saveBtn = (Button) findViewById(R.id.btn_camerapicksave_save);
