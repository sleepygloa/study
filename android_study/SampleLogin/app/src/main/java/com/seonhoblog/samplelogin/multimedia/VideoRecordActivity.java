...
public class VideoRecordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multimedia_video_record);
        ...
        FrameLayout frame = (FrameLayout) findViewById(R.id.fl_multimedia_video_record);
        frame.addView(surface);


        Button recordBtn = (Button) findViewById(R.id.btn_multimedia_video_record_record);
        Button recordStopBtn = (Button) findViewById(R.id.btn_multimedia_video_record_pause);
        Button playBtn = (Button) findViewById(R.id.btn_multimedia_video_record_play);
        Button playStopBtn = (Button) findViewById(R.id.btn_multimedia_video_record_stop);
