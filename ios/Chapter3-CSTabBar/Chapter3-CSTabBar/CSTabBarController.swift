...
//  Chapter3-CSTabBar
//
//  Created by seonho on 2022/05/02.
//
...
class CSTabBarController : UITabBarController{
    ...
    override func viewDidLoad() {
        ...
        //처음에 첫 번째 앱이 선택되어 있도록 초기 상태를 정의해준다
    ...
    func addTabBarBtn(btn: UIButton, title:String, tag:Int){
        ...
        btn.setTitleColor(UIColor.white, for: .normal) //일반상태
        btn.setTitleColor(UIColor.yellow, for: .selected) //선택상태
